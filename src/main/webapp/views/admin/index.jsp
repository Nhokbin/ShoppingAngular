...
<head>
	...
	<!-- Bootstrap 3.3.5 -->
	<link
		href="/shopping/assets/admin/libs/bootstrap/dist/css/bootstrap.min.css"
	...
	<link href="/shopping/assets/admin/libs/toastr/toastr.css" rel="stylesheet" type="text/css"/>
	<!-- Theme style -->
	<link href="/shopping/assets/admin/css/AdminLTE.css" rel="stylesheet"
		type="text/css" />
	<!-- AdminLTE Skins. Choose a skin from the css/skins
		         folder instead of downloading all of them to reduce the load. -->
	<link href="/shopping/assets/admin/css/skins/_all-skins.min.css"
		rel="stylesheet" type="text/css" />
	<!-- iCheck -->
	
	<link href="/shopping/assets/admin/libs/iCheck/flat/blue.css"
		rel="stylesheet" type="text/css" />
	<!-- Morris chart -->
	
	<link href="/shopping/assets/admin/libs/morris/morris.css"
		rel="stylesheet" type="text/css" />
	<!-- jvectormap -->
	
	<link
		href="/shopping/assets/admin/libs/jvectormap/jquery-jvectormap-1.2.2.css"
		rel="stylesheet" type="text/css" />
	<!-- Date Picker -->
	
	<link href="/shopping/assets/admin/libs/datepicker/datepicker3.css"
		rel="stylesheet" type="text/css" />
	<!-- Daterange picker -->
	
	<link
		href="/shopping/assets/admin/libs/daterangepicker/daterangepicker-bs3.css"
		rel="stylesheet" type="text/css" />
	<!-- bootstrap wysihtml5 - text editor -->
	
	<link
		href="/shopping/assets/admin/libs/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css"
		rel="stylesheet" type="text/css" />

</head>
	<body class="hold-transition skin-blue sidebar-mini" ng-app="tedushop">
		<div class="wrapper">
						...
						<ul class="nav navbar-nav">
										...
										<ul class="menu">
											<li>
												<!-- start message --> <a href="#">
													<div class="pull-left">
														<img src="/shopping/assets/admin/img/user2-160x160.jpg"
											...
											<li><a href="#">
													<div class="pull-left">
														<img src="/shopping/assets/admin/img/user3-128x128.jpg"
															class="img-circle" alt="User Image">
													</div>
													<h4>
											...
											<li><a href="#">
													<div class="pull-left">
														<img src="/shopping/assets/admin/img/user4-128x128.jpg"
															class="img-circle" alt="User Image">
													</div>
													<h4>
							...
							<li class="dropdown user user-menu"><a href="#"
								class="dropdown-toggle" data-toggle="dropdown"> <img
									src="/shopping/assets/admin/img/user2-160x160.jpg"
		...
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/jquery/dist/jquery.js">
		</script>
		<!-- jQuery UI 1.11.4 -->
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/jquery-ui/jquery-ui.min.js">
		</script>
		...
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/bootstrap/dist/js/bootstrap.min.js">
		</script>
		
		<!-- Sparkline -->
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/sparkline/jquery.sparkline.min.js">
		</script>
		<!-- jvectormap -->
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/jvectormap/jquery-jvectormap-1.2.2.min.js">
		</script>
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/jvectormap/jquery-jvectormap-world-mill-en.js">
		</script>
		<!-- jQuery Knob Chart -->
	
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/knob/jquery.knob.js">
		</script>
		<!-- daterangepicker -->
		<script
			src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/daterangepicker/daterangepicker.js">
		</script>
		<!-- datepicker -->
	
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/datepicker/bootstrap-datepicker.js">
		</script>
		<!-- Bootstrap WYSIHTML5 -->
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js">
		</script>
	
		<!-- Slimscroll -->
	
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/slimScroll/jquery.slimscroll.min.js">
		</script>
		<!-- FastClick -->
	
		<script type="text/javascript"
			src="/shopping/assets/admin/libs/fastclick/lib/fastclick.js">
		</script>
		<!-- AdminLTE App -->
		<script type="text/javascript"
			src="/shopping/assets/admin/js/app.min.js">
		</script>
		<!-- AdminLTE for demo purposes -->
		<script type="text/javascript" src="/shopping/assets/admin/js/demo.js">
		</script>
		<script src="/shopping/assets/admin/libs/angular/angular.js"
			type="text/javascript">
		</script>
		<script
			src="/shopping/assets/admin/libs/angular-ui-router/release/angular-ui-router.js"
			type="text/javascript">
		</script>
		<script src="/shopping/assets/admin/libs/toastr/toastr.min.js" type="text/javascript">
		</script>
		
		
		<script src="/shopping/app/shared/modules/tedushop.common.js"
			type="text/javascript">
		</script>
		<script src="/shopping/app/shared/filters/statutsFilter.js" type="text/javascript">
		</script>
		<script src="/shopping/app/shared/services/apiService.js" type="text/javascript">
		</script>
		<script src="/shopping/app/shared/directives/pagerDirective.js" type="text/javascript">
		</script>
		<script src="/shopping/app/shared/services/notificationService.js" type="text/javascript">
		</script>
		<script src="/shopping/app/components/products/products.module.js"
			type="text/javascript">
		</script>
		<script src="/shopping/app/components/product_categoies/productCategories.module.js" type="text/javascript">
		</script>
		<script src="/shopping/app/app.js" type="text/javascript">
		</script>
		<script src="/shopping/app/components/product_categoies/productCategoryListController.js" type="text/javascript">
		</script>
		<script src="/shopping/app/components/product_categoies/productCategoryAddController.js" type="text/javascript">
		</script>
		<script src="/shopping/app/components/products/productAddController.js"
			type="text/javascript">
		</script>
		<script	src="/shopping/app/components/products/productListController.js"
			type="text/javascript">
		</script>
		<script src="/shopping/app/components/home/homeController.js"
			type="text/javascript">
		</script>
	</body>
</html>
